      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-7xl mx-auto w-full">
        <WobbleCard containerClassName="f col-span-1 row-span-1 min-h-[300px] bg-[#501FA3]">
          ...
          <p className="mt-4 text-left  text-base/6 text-neutral-200">
            Patients with chronic diseases often require long-term medication
            regimens, which can be complex and difficult to manage. Adherence to
            these regimens is crucial for effective treatment.
          </p>
        </WobbleCard>
          ...
          <div className="flex flex-col  md:flex-row w-full h-full justify-between items-center">
            <div>
              <h2 className="  text-left text-balance text-2xl md:text-2xl lg:text-4xl font-extrabold tracking-[-0.015em] text-white">
                Personalized Medicine Delivery Systems for Chronic Diseases
                (Idea)
              </h2>
            </div>
            <svg
        ...
        <WobbleCard containerClassName="col-span-1 lg:col-span-2 bg-[#7C1FA3] min-h-[500px] lg:min-h-[600px] xl:min-h-[300px]">
          ...
          <div className="mt-4 text-left text-base/6 text-neutral-200">
            <Step title="Creating drug delivery systems that can be tailored to individual patient needs and metabolism" />
            <Step title="Ensuring the stability and efficacy of medications in novel delivery formats" />
            <Step title="Integrating smart technologies for monitoring and adjusting dosages in real-time" />
          </div>
        </WobbleCard>
        <WobbleCard containerClassName="col-span-1 lg:col-span-1 h-full bg-[#251FA3] min-h-[500px] lg:min-h-[300px]">
          ...
          <p className="mt-4 max-w-[26rem] text-left  text-base/6 text-neutral-200">
            Developing personalized medicine delivery systems can improve
            patient compliance, reduce side effects, and enhance treatment
            outcomes for chronic diseases such as diabetes, hypertension, and
            arthritis.
          </p>
        </WobbleCard>
      </div>
