      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-7xl mx-auto w-full">
        <WobbleCard containerClassName="f col-span-1 row-span-1 min-h-[300px] bg-[#501FA3]">
          ...
          <p className="mt-4 text-left  text-base/6 text-neutral-200">
            Small-scale farmers often struggle with maintaining soil fertility
            and crop yields due to limited land and resources. Traditional
            farming practices can lead to soil degradation and reduced
          ...
          <div className="flex flex-col  md:flex-row w-full h-full justify-between items-center">
            <div>
              <h2 className="  text-left text-balance text-2xl md:text-2xl lg:text-4xl font-extrabold tracking-[-0.015em] text-white">
                Sustainable Crop Rotation Systems for Small-Scale Farmers(Idea)
              </h2>
            </div>
            <svg
        ...
        <WobbleCard containerClassName="col-span-1 lg:col-span-2 bg-[#7C1FA3] min-h-[500px] lg:min-h-[600px] xl:min-h-[300px]">
          ...
          <div className="mt-4 text-left text-base/6 text-neutral-200">
            <Step title="Designing rotation systems that balance soil nutrient requirements, market demands, and farmers’ economic needs" />
            <Step title="Educating farmers on the benefits and implementation of crop rotation techniques" />
            <Step title="Adapting rotation systems to various climatic conditions and soil types" />
          </div>
        </WobbleCard>
        <WobbleCard containerClassName="col-span-1 lg:col-span-1 h-full bg-[#251FA3] min-h-[500px] lg:min-h-[300px]">
          ...
          <p className="mt-4 max-w-[26rem] text-left  text-base/6 text-neutral-200">
            Developing sustainable crop rotation systems tailored for
            small-scale farmers can improve soil health, increase crop
            diversity, and enhance food security for local communities. This
            approach can also reduce reliance on chemical fertilizers and
            pesticides
          </p>
        </WobbleCard>
      </div>
