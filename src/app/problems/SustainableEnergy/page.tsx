      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-7xl mx-auto w-full">
        <WobbleCard containerClassName="f col-span-1 row-span-1 min-h-[300px] bg-[#501FA3]">
          ...
          <p className="mt-4 text-left  text-base/6 text-neutral-200">
            Marine vessels are major contributors to global carbon emissions,
            with traditional diesel engines being a significant source of
            pollution. Hybrid propulsion systems, which combine conventional
            engines with alternative energy sources such as batteries or
            renewable energy, offer a solution to reduce the environmental
            impact of marine transport.
          </p>
        </WobbleCard>
          ...
          <div className="flex flex-col  md:flex-row w-full h-full justify-between items-center">
            <div>
              <h2 className="  text-left text-balance text-2xl md:text-2xl lg:text-4xl font-extrabold tracking-[-0.015em] text-white">
                Sustainable Energy Solutions for Marine Vessels - Hybrid
                Propulsion Systems(Idea)
              </h2>
            </div>
            <svg
        ...
        <WobbleCard containerClassName="col-span-1 lg:col-span-2 bg-[#7C1FA3] min-h-[500px] lg:min-h-[600px] xl:min-h-[300px]">
          ...
          <div className="mt-4 text-left text-base/6 text-neutral-200">
            <Step title="Developing efficient and scalable hybrid propulsion systems that can handle the energy demands of large marine vessels" />
            <Step title="Ensuring the reliability and safety of these systems in harsh marine environments" />
            <Step title="Addressing the high initial investment costs for retrofitting existing vessels or building new hybrid ships" />
          </div>
        </WobbleCard>
        <WobbleCard containerClassName="col-span-1 lg:col-span-1 h-full bg-[#251FA3] min-h-[500px] lg:min-h-[300px]">
          ...
          <p className="mt-4 max-w-[26rem] text-left  text-base/6 text-neutral-200">
            Implementing hybrid propulsion systems can lower fuel consumption,
            reduce greenhouse gas emissions, and contribute to cleaner, more
            energy-efficient marine operations. This aligns with international
            goals for sustainable shipping and reducing maritime carbon
            footprints.
          </p>
        </WobbleCard>
      </div>
